...
class keyListener implements DialogInterface.OnKeyListener {
    ...
    public boolean onKey(DialogInterface dialog, int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK || keyCode == KeyEvent.KEYCODE_ESCAPE || keyCode == KeyEvent.KEYCODE_BUTTON_B) {
            if (_c.get()._newFolderView != null && Objects.requireNonNull(_c.get()._newFolderView).getVisibility() == VISIBLE) {
                Objects.requireNonNull(_c.get()._newFolderView).setVisibility(GONE);
                return true;
            }
                ...
                if (_c.get()._neutralBtn.hasFocus() || _c.get()._negativeBtn.hasFocus()
                    ...
                    if (_c.get()._options != null && _c.get()._options.getVisibility() == VISIBLE) {
                        ...
                        return true;
                            ...
                            && Objects.requireNonNull(_c.get()._newFolderView).getVisibility() == VISIBLE) {
                        Objects.requireNonNull(_c.get()._newFolderView).requestFocus(View.FOCUS_LEFT);
                        return true;
                    } else {
