package com.ntduc.musicplayerutils.glide;
...
public final class GlideOptions extends RequestOptions implements Cloneable {
  ...
  /**
   * @see RetroGlideExtension#artistImageOptions(BaseRequestOptions, Artist)
   */
  @SuppressWarnings("unchecked")
  @CheckResult
  @NonNull
  public GlideOptions artistImageOptions(@NotNull Artist artist) {
    return (GlideOptions) RetroGlideExtension.artistImageOptions(this, artist);
  }

  /**
   * @see RetroGlideExtension#songCoverOptions(BaseRequestOptions, Song)
   */
  @SuppressWarnings("unchecked")
  @CheckResult
  @NonNull
  public GlideOptions songCoverOptions(@NotNull Song song) {
    return (GlideOptions) RetroGlideExtension.songCoverOptions(this, song);
  }

  /**
   * @see RetroGlideExtension#simpleSongCoverOptions(BaseRequestOptions, Song)
   */
  @SuppressWarnings("unchecked")
  @CheckResult
  @NonNull
  public GlideOptions simpleSongCoverOptions(@NotNull Song song) {
    return (GlideOptions) RetroGlideExtension.simpleSongCoverOptions(this, song);
  }

  /**
   * @see RetroGlideExtension#albumCoverOptions(BaseRequestOptions, Song)
   */
  @SuppressWarnings("unchecked")
  @CheckResult
  @NonNull
  public GlideOptions albumCoverOptions(@NotNull Song song) {
    return (GlideOptions) RetroGlideExtension.albumCoverOptions(this, song);
  }
  ...
  /**
   * @see RetroGlideExtension#playlistOptions(BaseRequestOptions)
   */
  @SuppressWarnings("unchecked")
  @CheckResult
  @NonNull
  public GlideOptions playlistOptions() {
    return (GlideOptions) RetroGlideExtension.playlistOptions(this);
  }
   ...
   */
  @CheckResult
  public static GlideOptions artistImageOptionsOf(@NotNull Artist artist) {
    return new GlideOptions().artistImageOptions(artist);
  }
  ...
  public static GlideOptions songCoverOptionsOf(@NotNull Song song) {
    return new GlideOptions().songCoverOptions(song);
  }
  ...
  public static GlideOptions simpleSongCoverOptionsOf(@NotNull Song song) {
    return new GlideOptions().simpleSongCoverOptions(song);
  }
   ...
   */
  @CheckResult
  public static GlideOptions albumCoverOptionsOf(@NotNull Song song) {
    return new GlideOptions().albumCoverOptions(song);
  }
   ...
   */
  @CheckResult
  public static GlideOptions playlistOptionsOf() {
    return new GlideOptions().playlistOptions();
  }
}
