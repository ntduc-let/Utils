...
fun Context.loadImg(imgUrl: Any?, view: AppCompatImageView, @DrawableRes error: Int, @DrawableRes placeHolder: Int) {
    Glide.with(this)
        .load(imgUrl)
        .placeholder(placeHolder)
        .error(error)
...
fun View.loadImg(imgUrl: Any?, view: AppCompatImageView, @DrawableRes error: Int, @DrawableRes placeHolder: Int) {
    Glide.with(this)
        .load(imgUrl)
        .placeholder(placeHolder)
        .error(error)
