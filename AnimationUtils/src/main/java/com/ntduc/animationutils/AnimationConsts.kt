package com.ntduc.animationutils
...
object AnimationConstants {
    ...
    val TRANSLATION_SMALL = 16
    val TRANSLATION_MICRO = 4
...
//Di chuyển
fun View.translate(
    initX: Int? = null, initY: Int? = null, translationX: Int = 0, translationY: Int = 0,
    initAlpha: Float? = null, alpha: Float = 1f, startDelay: Long = 0,
    build: (ViewPropertyAnimator.() -> Unit)? = null
) {
...
fun View.fadeInVertical(startDelay: Long = 0, build: (ViewPropertyAnimator.() -> Unit)? = null) =
    translate(
        initY = AnimationConstants.TRANSLATION_SMALL,
        translationY = 0,
        alpha = 1f,
...
//Di chuyển lên trên rồi biến mất
fun View.fadeOutVertical(startDelay: Long = 0, build: (ViewPropertyAnimator.() -> Unit)? = null) =
    translate(
        translationY = -AnimationConstants.TRANSLATION_SMALL,
        alpha = 0f,
        startDelay = startDelay
    ) {
...
//Di chuyển sang trái thì biến mất
fun View.fadeOutHorizontal(startDelay: Long = 0, build: (ViewPropertyAnimator.() -> Unit)? = null) =
    translate(
        translationX = -AnimationConstants.TRANSLATION_SMALL,
        alpha = 0f,
        startDelay = startDelay
    ) {
        duration = AnimationConstants.SHORT
...
//Hiển thị các view ẩn di chuyển từ dưới lên
fun easeViewsInVertical(
    startDelay: Long = 0,
    vararg views: View?,
    build: (ViewPropertyAnimator.() -> Unit)? = null
) {
...
//Hiển thị view (nếu bị ẩn) di chuyển từ dưới lên
...
//Hiển thị các view ẩn di chuyển từ phải sang
fun easeViewsInHorizontal(
    startDelay: Long = 0,
    vararg views: View?,
    build: (ViewPropertyAnimator.() -> Unit)? = null
) {
...
//Hiển thị view (nếu bị ẩn) di chuyển từ phải sang
...
fun View.reveal(
    show: Boolean = true, centerX: Int? = null, centerY: Int? = null,
